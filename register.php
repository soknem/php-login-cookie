    ...
    <div class="flex w-full">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-6">
            <div class="bg-white bg-opacity-90 rounded-xl p-8 w-full max-w-md border border-yellow-600 shadow-lg">
                <h2 class="text-3xl font-bold text-center mb-8 text-black">Sign Up</h2>
                <?php if ($error): ?>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" class="w-full p-3 bg-white bg-opacity-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black transition duration-300" placeholder="Enter email" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="password" name="confirm_password" class="w-full p-3 bg-white bg-opacity-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black transition duration-300" placeholder="Confirm password" required>
                    </div>
                    <button type="submit" class="w-full bg-black text-white p-3 rounded-lg hover:bg-gray-800 transition duration-300 transform hover:scale-105">Sign Up</button>
                </form>
                <p class="text-center text-black mt-6">Already have an account? <a href="index.php" class="text-black underline hover:text-gray-700">Sign in</a></p>
            </div>
        </div>
        <!-- Image Section -->
